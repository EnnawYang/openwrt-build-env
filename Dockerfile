...
RUN apt-get -y update \
    ...
    ack antlr3 aria2 asciidoc autoconf automake autopoint binutils bison build-essential bzip2 ccache cpio device-tree-compiler ecj fastjar flex gawk gettext \
